...
for i = 1
    ...
    fileName = [C{1} '_' specType{i}];
    
    load(['SpecReg/Data/' fileName '.spa'], '-mat');
...
%     wconc   = wconc./(1-CSFfrac);
    ...
    fprintf(fileid,[' ATTH2O=' num2str(2*0.7) '\n']); % to match GE x2 because of diff spec
